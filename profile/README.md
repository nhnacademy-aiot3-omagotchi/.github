...
> 팀원 프로필 및 서비스 내 캐릭터는 저작자가 별도로 창작·등록한 미술저작물 **「시로몽」**(등록번호 `C-2026-040776`)을 본 프로젝트에 이용한 것입니다. 자세한 내용은 [저작권 및 캐릭터 IP](#저작권-및-캐릭터-ip)를 참고해 주세요.
...
본 저작물은 Omagotchi 프로젝트를 위해 제작된 결과물이 아니라, **저작자가 프로젝트와 별개로 독자적으로 창작하여 등록한 개인 저작물**이며 본 프로젝트에 이용을 허락한 것입니다. 따라서 저작권은 프로젝트나 팀에 귀속되지 않고 **저작자 개인에게 있습니다.**
...
- 본 저작물은 **Omagotchi 프로젝트 내 사용에 한해** 이용이 허락되었습니다.
